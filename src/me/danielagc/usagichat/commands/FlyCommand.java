...
public class FlyCommand extends PluginCommand {
    ...
    public void execute(Player p, String[] args) {
        if (!p.getAllowFlight()) {
            ...
            p.sendMessage("§7[§6§lUsagi§fłNetwork§7]: Seu fly foi ativado, agora você poderá voar");
        } else {
            p.setAllowFlight(false);
            p.sendMessage("§7[§6§lUsagi§fłNetwork§7]: Seu fly foi desativado, agora não você poderá voar");
        }
    }
}
